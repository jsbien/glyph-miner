...
<h3>INPUT</h3>
$:dicttable(webapp.input(_unicode=False))

<h3 id="cookie-info">COOKIES</h3>
$:dicttable(webapp.cookies())
...
<div id="explanation">
  <p>
    You're seeing this error because you have <code>webapp.config.debug</code>
...
def djangoerror():
    ...
    t = djangoerror_r
    globals = {'ctx': webapp.ctx, 'webapp':webapp, 'dict':dict, 'str':str, 'prettify': prettify}
...
def debugerror():
    ...
    """
    return webapp._InternalError(djangoerror())
...
def emailerrors(to_address, olderror, from_address=None):
    ...
    def emailerrors_internal():
        ...
        request = webapp.ctx.method + ' ' + webapp.ctx.home + webapp.ctx.fullpath
