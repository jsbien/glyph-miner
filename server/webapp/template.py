...
class Template(BaseTemplate):
    ...
    def __call__(self, *a, **kw):
        ...
        if 'headers' in webapp.ctx and self.content_type:
            webapp.header('Content-Type', self.content_type, unique=True)
...
def compile_templates(root):
    ...
    for dirpath, dirnames, filenames in os.walk(root):
        ...
        out.write('from webapp.template import CompiledTemplate, ForLoop, TemplateResult\n\n')
        if dirnames:
