    ...
    class WSGIHandler(http.server.SimpleHTTPRequestHandler):
        def run_wsgi_app(self):
            ...
            try:
                ...
                print(traceback.format_exc(), end=' ', file=webapp.debug)
...
def WSGIServer(server_address, wsgi_app):
    ...
    # prefix. Overwriting it make it work with webapp.wsgiserver.
    wsgiserver.ssl_adapters = {
        'builtin': 'webapp.wsgiserver.ssl_builtin.BuiltinSSLAdapter',
        'pyopenssl': 'webapp.wsgiserver.ssl_pyopenssl.pyOpenSSLAdapter',
    }
    ...
    def create_ssl_adapter(cert, key):
        ...
        # That doesn't work as not it is webapp.wsgiserver. 
...
class LogMiddleware:
    ...
    def log(self, status, environ):
        outfile = environ.get('wsgi.errors', webapp.debug)
