...
def main():
    ...
    collection_id = find_or_create_collection(args.collection, args.dry_run, api)
    ...
    for bw_img in image_paths:
        ...
        upload_image(doc_id, bw_img, "color", args.dry_run, api)
        upload_image(doc_id, bw_img, "binarized", args.dry_run, api)
        assign_to_collection(doc_id, collection_id, args.dry_run, title, args.collection, api)
